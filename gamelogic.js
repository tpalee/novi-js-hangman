function displayWordSoFar(word, guesses) {
    ...
    // na het itereren return je de resultarray omgezet naar een string
    return resultArray.join("");
}


function isGameWon(word, guesses) {
    // log uitkomst van displayWordSoFar in de console
...
//  functie met switch statement tekent de galg aan de hand van het aantal fouten(counter)
